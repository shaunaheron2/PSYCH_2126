...
Next you will download the MY_ASSIGNMENT template from D2l, and copy it to the root directory of your project folder (see previous step). Once copied to your project folder, head back to the R Studio workspace and from the file pane, select the file you just placed there (click on it). This should open the R Markdown document in your workspace. This document will be your working document. It is designed to work like a template; simply replace my prompts and instructions with your own text.
